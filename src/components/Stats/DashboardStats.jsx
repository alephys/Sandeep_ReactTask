...
const DashboardStats = ({ stats }) => {
  ...
  return (
    <div style={gridStyle} className="mb-8">
      ...
      {/* TOTAL REQUESTS */}
      <div style={{ gridArea: "total" }} className="bg-white shadow p-6 rounded-lg text-center">
        <h3 className="text-gray-500 text-sm">Total Topic Requests</h3>
        <p className="text-4xl font-bold text-purple-600">{stats.requests_total}</p>
      </div>

      {/* TOPICS ADMIN */}
      <div style={{ gridArea: "admin" }} className="bg-white shadow p-6 rounded-lg text-center">
        <h3 className="text-gray-500 text-sm">Topics Created by Admin</h3>
        <p className="text-4xl font-bold text-green-600">{stats.topics_admin}</p>
      </div>

      {/* TOPICS USERS */}
      <div style={{ gridArea: "user" }} className="bg-white shadow p-6 rounded-lg text-center">
      ...
      {/* APPROVED */}
      <div style={{ gridArea: "approved" }} className="bg-white shadow p-6 rounded-lg text-center">
        <h3 className="text-gray-500 text-sm">Approved Requests</h3>
        <p className="text-4xl font-bold text-green-700">{stats.requests_approved}</p>
      </div>

      {/* DECLINED */}
      <div style={{ gridArea: "declined" }} className="bg-white shadow p-6 rounded-lg text-center">
        <h3 className="text-gray-500 text-sm">Declined Requests</h3>
        <p className="text-4xl font-bold text-red-600">{stats.requests_declined}</p>
      </div>

      {/* ACLS */}
      <div style={{ gridArea: "acls" }} className="bg-white shadow p-6 rounded-lg text-center">
